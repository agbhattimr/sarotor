...
class NewOrderMeasurementsScreen extends ConsumerWidget {
  const NewOrderMeasurementsScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Step 2: Select Measurements'),
      ),
        ...
        data: (measurements) {
          ...
          return validationResultAsync.when(
            ...
            data: (validationResult) {
              final canNavigate = validationResult.isValid;
              return Column(
                children: [
                  Expanded(
                              ...
                              children: [
                                ...
                                CustomRadioGroup<String>(
                                  ...
                                  onChanged: (String? value) {
                                    if (value != null) {
                                      ref
                                          .read(selectedMeasurementsProvider
                                              .notifier)
