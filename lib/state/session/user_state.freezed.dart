...
class _$AuthenticatedImpl implements _Authenticated {
  const _$AuthenticatedImpl({required this.profile});
  ...
  @override
  String toString() {
    return 'UserState.authenticated(profile: $profile)';
  }
...
abstract class _Authenticated implements UserState {
  const factory _Authenticated({required final UserProfile profile}) =
      _$AuthenticatedImpl;
