...
INSERT INTO public.services (
  category_id, name, description, price_cents, estimated_delivery_days, 
  is_urgent_delivery_available, is_coming_soon, service_type, is_active
) VALUES
(
...
-- Add some sample service images (placeholder URLs)
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/FF6B6B/FFFFFF?text=Simple+Suit' WHERE name = 'Simple Suit';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/4ECDC4/FFFFFF?text=Double+Suit' WHERE name = 'Double Suit';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/45B7D1/FFFFFF?text=Paneled+Frock' WHERE name = 'Paneled Frock Set';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/96CEB4/FFFFFF?text=Sarhi' WHERE name = 'Sarhi';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/FFEAA7/FFFFFF?text=Lehenga+Set' WHERE name = 'Lehenga Set';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/DDA0DD/FFFFFF?text=Bridal+Set' WHERE name = 'Bridal Set';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/98D8C8/FFFFFF?text=Maxi+Set' WHERE name = 'Maxi Set';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/F7DC6F/FFFFFF?text=Trouser' WHERE name = 'Trouser';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/BB8FCE/FFFFFF?text=Shirt' WHERE name = 'Shirt';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/85C1E9/FFFFFF?text=Shalwar+Suit' WHERE name = 'Shalwar Suit Simple';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/F8C471/FFFFFF?text=Pant+Coat' WHERE name = 'Pant Coat';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/82E0AA/FFFFFF?text=Dupatta' WHERE name = 'Dupatta Stitching';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/F1948A/FFFFFF?text=Pickup+Delivery' WHERE name = 'Pickup/Delivery';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/85C1E9/FFFFFF?text=External+Purchase' WHERE name = 'External Purchase Handling';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/D7BDE2/FFFFFF?text=Embroidery' WHERE name = 'Custom Embroidery';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/F9E79F/FFFFFF?text=Bead+Work' WHERE name = 'Bead Work';
UPDATE public.services SET image_url = 'https://via.placeholder.com/300x400/FADBD8/FFFFFF?text=Zardozi' WHERE name = 'Zardozi Work';
